                        ...
                        <td className="p-4">
                          {item.planos_adquiridos ? (
                            <div>
                              ...
                              <div className="text-sm text-muted-foreground">ID {item.planos_adquiridos.id_carteira}</div>
                            </div>
                          ) : (
            ...
            {selectedSolicitacao && (
              <>
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-1 border-l-4 border-primary">
                  ...
                  {selectedSolicitacao.planos_adquiridos && (
                    <div className="text-sm text-foreground mt-2">
                      <span className="font-medium">Plano: </span>
                      {selectedSolicitacao.planos_adquiridos.planos.nome_plano} - ID {selectedSolicitacao.planos_adquiridos.id_carteira}
                    </div>
                  )}
